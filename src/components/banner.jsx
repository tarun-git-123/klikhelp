...
const banner = () => {
  return (
    <div className="relative max-w-full z-[0] sm:mt-[-50px] mt-0">
        <img src={bannerImg} alt='banner_img'/>
        <div className='max-w-100 absolute text-white top-[2%] lg:top-[20%] sm:top-[20%] left-[12px] xl:left-[122px] sm:left-[20px] mt-4 flex'>
        ...
        <div className='absolute text-white top-[2%] xl:top-[2%] left-[20px] xl:left-[122px] sm:left-[30px] xl:mt-[13%] sm:mt-[15%] mt-[45px] font-[monospace] xl:text-6xl sm:text-xl text-[10px] sm:font-semibold font-medium'>
            Rediscover<br/>patient experience<br/> with AI
        </div>
        <div className='absolute w-[47%] text-white top-[2%] xl:top-[4%] left-[20px] xl:left-[122px] sm:left-[30px] sm:mt-[27%] mt-[100px] font-[monospace] sm:text-[15px] text-[8px] sm:font-medium font-medium'>It is a long established fact that a reader will be distracted by the readable 
